...
const WINDOWS = {
  name: 'Windows',
  link: 'https://github.com/mjmlio/mjml-app/releases/download/1.3.2/mjml-app-win32-x64.zip',
  gtm () {
    dataLayer.push({
...
const LINUX = {
  name: 'Linux',
  link: 'https://github.com/mjmlio/mjml-app/releases/download/1.2.0/mjml-app-linux-x64.zip',
  gtm () {
    dataLayer.push({
      eventValue: 'mjmlApp-Downloaded',
      event: 'mjml-app',
...
const OSX = {
  name: 'OS X',
  link: 'https://github.com/mjmlio/mjml-app/releases/download/1.3.2/mjml-app-osx.dmg',
  gtm () {
    dataLayer.push({
      eventValue: 'mjmlApp-Downloaded',
      event: 'mjml-app',
