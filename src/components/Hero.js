...
const WINDOWS = { name: 'Windows', link: 'https://github.com/mjmlio/mjml-app/releases/download/1.1.0/MJML-win32-x64.zip' }
const LINUX = { name: 'Linux', link: 'https://github.com/mjmlio/mjml-app/releases/download/1.1.1/mjml-app-linux-x64.zip' }
const OSX = { name: 'OS X', link: 'https://github.com/mjmlio/mjml-app/releases/download/1.1.1/mjml-app-osx.dmg' }
